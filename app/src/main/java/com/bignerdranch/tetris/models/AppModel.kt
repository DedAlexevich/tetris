...
import com.bignerdranch.tetris.helpers.array2dOfByte
import com.bignerdranch.tetris.storage.AppPreferences
...
class AppModel {
    ...
    fun generateField(action: String) {
        if (isGameActive()) {
            resetField()
            var frameNumber = currentBlock?.frameNumder
            ...
            if (!moveValid(coordinate as Point, frameNumber)) {
                translateBlock(
                    ...
                    currentBlock?.frameNumder as Int
                )
